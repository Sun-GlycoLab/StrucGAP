...
plot_data = pd.DataFrame(index=['Preprocessed data'],
                         columns=['PSMs','Unique IGPs','Glycoproteins',
...
#             figure_description = 'Top 10 glycoproteins ranked by the number of unique glycan compositions observed across all glycosylation sites, reflecting glycan structural diversity.',
#             yaxis_title_gap = 70,
#             xaxis_label_font_size = 30,
#             yaxis_label_font_size = 30,
#             legend_font_size = 30,
