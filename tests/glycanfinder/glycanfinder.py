# -*- coding: utf-8 -*-
"""
Created on Wed Aug 27 17:51:10 2025
...
os.chdir('D:\\doctor\\analysisys\\StrucGAP\\glycanfinder')

# only structure information
module1 = StrucGAP_Preprocess(data_dir="D:\\doctor\\analysisys\\data\\others output\\glycanfinder.xlsx",
                      data_sheet_name = 'GF_orbi_glycan.glycopsms',
...
module5 = StrucGAP_FunctionAnnotation(module1, 
                                 data_manager=data_manager)  
module5.ora(organism='hsapiens', background_input=False, up_down_fc_threshold=1.5) # 65,72,79
