...
os.chdir('D:\\doctor\\analysisys\\StrucGAP\\byonic')

# only structure information
module1 = StrucGAP_Preprocess(data_dir="D:\\doctor\\analysisys\\data\\others output\\byonic.xlsx",
                      data_sheet_name = 'Spectra',
