...
fig6 = module7.bar_up_down_ratio(feature='fucosylated_type', 
                          colors=random_colors,
                          subfolder='StrucGAP_GlycoPeptideQuant_4',
                          filename="fucosylated_type",
                          xaxis_font_size = 25,
...
fig7 = module7.bar_up_down_ratio(feature='acgc', 
                          colors=random_colors,
                          subfolder='StrucGAP_GlycoPeptideQuant_4',
                          filename="acgc",
                          xaxis_font_size = 25,
...
merger = PdfMerger()
merger.append("tests/StrucGAP_GlycoSite_1.pdf")
merger.append("tests/StrucGAP_GlycanStructure_1.pdf")
merger.append("tests/StrucGAP_GlycanStructure_2.pdf")
merger.append("tests/StrucGAP_GlycanStructure_3.pdf")
merger.append("tests/StrucGAP_GlycanStructure_4.pdf")
merger.append("tests/StrucGAP_GlycanStructure_5.pdf")
merger.append("tests/StrucGAP_GlycanStructure_6.pdf")
merger.append("tests/Glycan structures coding rule.pdf")
merger.write("tests/StrucGAP_GlycoSite_GlycanStructure.pdf")
merger.close()
