...
for i in ['core_structure','glycan_type','branches_structure','branches_count',
    ...
    data = pd.read_excel("analysis_result_quant/StrucGAP_GlycoPeptideQuant_key_information.xlsx", sheet_name=i)
    if not data.empty:
    ...
    da_data = pd.read_excel("analysis_result_quant/StrucGAP_GlycoPeptideQuant_key_information.xlsx", sheet_name=f'da_{i}')
...
sheet_names = pd.ExcelFile("analysis_result_quant/StrucGAP_FunctionAnnotation_GO_ora_no_background_up_result_key_information.xlsx").sheet_names
figs = []
pdf_index = 1  
for sheet in sheet_names: # sheet='cc_branches_count'
    df = pd.read_excel("analysis_result_quant/StrucGAP_FunctionAnnotation_GO_ora_no_background_up_result_key_information.xlsx", sheet_name=sheet, header=None)
    df = df.iloc[:,1:]
...
# key insights StrucGAP_FunctionAnnotation
sheet_names = pd.ExcelFile("analysis_result_quant/StrucGAP_FunctionAnnotation_GO_ora_no_background_down_result_key_information.xlsx").sheet_names
figs = []
pdf_index = 1  
for sheet in sheet_names: # sheet='cc_branches_count'
    df = pd.read_excel("analysis_result_quant/StrucGAP_FunctionAnnotation_GO_ora_no_background_down_result_key_information.xlsx", sheet_name=sheet, header=None)
    df = df.iloc[:,1:]
    df = df.replace('A2B2C1D1dD1','Core-I') \
                          .replace('A2B2C1D1dD1dcbB5','Core-II') \
                          .replace('A2B2C1D1dD2dD1','Core-III') \
