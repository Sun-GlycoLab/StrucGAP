...
A comprehensive analytical pipeline based on glycoproteomic data from GlycanFinder (data source: PXD039787):
...
.. code-block:: python
    ...
    module1 = StrucGAP_Preprocess(data_dir="tests/glycanfinder.xlsx",
