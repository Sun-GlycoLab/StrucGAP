...
A comprehensive analytical pipeline based on glycoproteomic data from Byonic (data source: PXD031032):
...
.. code-block:: python
    ...
    module1 = StrucGAP_Preprocess(data_dir="tests/byonic.xlsx",
