...
A comprehensive analytical pipeline based on glycoproteomic data from MSFragger-Glyco (data source: PXD021196):
...
.. code-block:: python
    ...
    module1 = StrucGAP_Preprocess(data_dir="tests/msfragger.xlsx",
