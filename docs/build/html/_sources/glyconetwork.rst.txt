...
.. code-block:: python
    ...
    module6.glycosyltransferases(glycosyltransferases_data_dir="tests/enzyme.xlsx", data_sheet_name="glycosyltransferases")
    module6.glycosidases(glycosidases_data_dir="tests/enzyme.xlsx", data_sheet_name='glycosidases')
